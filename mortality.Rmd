...
ggsave(filename = "figures/excess_by_cause_jurisdiction.pdf", out, height = 12, width = 12)
ggsave(filename = "figures/excess_by_cause_jurisdiction.png", out, height = 12, width = 12, dpi = 200)
